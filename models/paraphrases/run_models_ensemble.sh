...
export output_folder=$base_folder/outputs/results_ensemble
...
echo "Results"
python $base_folder/models/paraphrases/ensemble.py -d $output_folder -o $base_folder/outputs/results_ensemble.csv
