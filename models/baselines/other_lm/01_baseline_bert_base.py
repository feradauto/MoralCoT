...
def get_prediction(filename,prompt_number):
   ...
   """
    ...
    model = pipeline('fill-mask', model='bert-base-uncased',top_k=15)
...
def main():
    ...
    parser.add_argument('-o','--output_file', nargs='?', help='output file name',default='./bert_base_predictions.csv')
